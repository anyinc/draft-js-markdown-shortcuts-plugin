...
var createMarkdownShortcutsPlugin = function createMarkdownShortcutsPlugin() {
  ...
  return {
    ...
    handleReturn: function handleReturn(ev, editorState, _ref5) {
    ...
    handleBeforeInput: function handleBeforeInput(character, editorState, _ref6) {
    ...
    handlePastedText: function handlePastedText(text, html, editorState, _ref7) {
